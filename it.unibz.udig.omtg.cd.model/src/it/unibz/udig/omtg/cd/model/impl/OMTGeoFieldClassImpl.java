 ...
 * <ul>
 *   <li>{@link it.unibz.udig.omtg.cd.model.impl.OMTGeoFieldClassImpl#getRepresentation <em>Representation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OMTGeoFieldClassImpl extends OMTClassImpl implements OMTGeoFieldClass
{
	...
	{
		return CDPackage.Literals.OMT_GEO_FIELD_CLASS;
	}
	...
	public void setRepresentation( OMTGeoFieldClassKind newRepresentation )
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDPackage.OMT_GEO_FIELD_CLASS__REPRESENTATION, oldRepresentation, representation));
	}
	...
	public Object eGet( int featureID, boolean resolve, boolean coreType )
	{
		switch (featureID)
		{
			case CDPackage.OMT_GEO_FIELD_CLASS__REPRESENTATION:
