 ...
 * <ul>
 *   <li>{@link it.unibz.udig.omtg.cd.model.ClassOperation#getOmtclass <em>Omtclass</em>}</li>
 * </ul>
 * </p>
 *
 * @see it.unibz.udig.omtg.cd.model.CDPackage#getClassOperation()
 * @model
 * @generated
 */
public interface ClassOperation extends ClassElement
{
	 ...
	 * It is bidirectional and its opposite is '{@link it.unibz.udig.omtg.cd.model.OMTClass#getOperations <em>Operations</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see it.unibz.udig.omtg.cd.model.CDPackage#getClassOperation_Omtclass()
	...
	/**
	 * Sets the value of the '{@link it.unibz.udig.omtg.cd.model.ClassOperation#getOmtclass <em>Omtclass</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
