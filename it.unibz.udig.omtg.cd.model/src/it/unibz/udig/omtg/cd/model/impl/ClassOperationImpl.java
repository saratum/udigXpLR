 ...
 * <ul>
 *   <li>{@link it.unibz.udig.omtg.cd.model.impl.ClassOperationImpl#getOmtclass <em>Omtclass</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClassOperationImpl extends ClassElementImpl implements ClassOperation
{
	...
	{
		return CDPackage.Literals.CLASS_OPERATION;
	}
	...
	{
		if (eContainerFeatureID() != CDPackage.CLASS_OPERATION__OMTCLASS) return null;
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newOmtclass, CDPackage.CLASS_OPERATION__OMTCLASS, msgs);
		return msgs;
	}
	...
	{
		if (newOmtclass != eInternalContainer() || (eContainerFeatureID() != CDPackage.CLASS_OPERATION__OMTCLASS && newOmtclass != null))
		{
			...
			if (newOmtclass != null)
				msgs = ((InternalEObject)newOmtclass).eInverseAdd(this, CDPackage.OMT_CLASS__OPERATIONS, OMTClass.class, msgs);
			msgs = basicSetOmtclass(newOmtclass, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDPackage.CLASS_OPERATION__OMTCLASS, newOmtclass, newOmtclass));
	}
	...
	public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs )
	{
		switch (featureID)
		{
			case CDPackage.CLASS_OPERATION__OMTCLASS:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature( NotificationChain msgs )
	{
		...
		{
			case CDPackage.CLASS_OPERATION__OMTCLASS:
				return eInternalContainer().eInverseRemove(this, CDPackage.OMT_CLASS__OPERATIONS, OMTClass.class, msgs);
		}
