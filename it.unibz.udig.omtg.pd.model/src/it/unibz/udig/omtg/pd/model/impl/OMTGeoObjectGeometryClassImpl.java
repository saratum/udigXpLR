 ...
 * <ul>
 *   <li>{@link it.unibz.udig.omtg.pd.model.impl.OMTGeoObjectGeometryClassImpl#getRepresentation <em>Representation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OMTGeoObjectGeometryClassImpl extends OMTClassImpl implements OMTGeoObjectGeometryClass
{
	...
	{
		return PDPackage.Literals.OMT_GEO_OBJECT_GEOMETRY_CLASS;
	}
	...
	public void setRepresentation( OMTGeoObjectGeometryClassKind newRepresentation )
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PDPackage.OMT_GEO_OBJECT_GEOMETRY_CLASS__REPRESENTATION, oldRepresentation, representation));
	}
	...
	public Object eGet( int featureID, boolean resolve, boolean coreType )
	{
		switch (featureID)
		{
			case PDPackage.OMT_GEO_OBJECT_GEOMETRY_CLASS__REPRESENTATION:
