 ...
 * <ul>
 *   <li>{@link it.unibz.udig.omtg.pd.model.ClassOperation#getOmtclass <em>Omtclass</em>}</li>
 * </ul>
 * </p>
 *
 * @see it.unibz.udig.omtg.pd.model.PDPackage#getClassOperation()
 * @model
 * @generated
 */
public interface ClassOperation extends NameValueElement
{

	/**
	 * Returns the value of the '<em><b>Omtclass</b></em>' container reference.
	 * It is bidirectional and its opposite is '{@link it.unibz.udig.omtg.pd.model.OMTClass#getOperations <em>Operations</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see it.unibz.udig.omtg.pd.model.PDPackage#getClassOperation_Omtclass()
	...
	/**
	 * Sets the value of the '{@link it.unibz.udig.omtg.pd.model.ClassOperation#getOmtclass <em>Omtclass</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
