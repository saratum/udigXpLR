 ...
 * <ul>
 *   <li>{@link it.unibz.udig.omtg.pd.model.impl.OMTGeoObjectTopologyClassImpl#getRepresentation <em>Representation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OMTGeoObjectTopologyClassImpl extends OMTClassImpl implements OMTGeoObjectTopologyClass
{
	...
	{
		return PDPackage.Literals.OMT_GEO_OBJECT_TOPOLOGY_CLASS;
	}
	...
	public void setRepresentation( OMTGeoObjectTopologyClassKind newRepresentation )
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PDPackage.OMT_GEO_OBJECT_TOPOLOGY_CLASS__REPRESENTATION, oldRepresentation, representation));
	}
	...
	public Object eGet( int featureID, boolean resolve, boolean coreType )
	{
		switch (featureID)
		{
			case PDPackage.OMT_GEO_OBJECT_TOPOLOGY_CLASS__REPRESENTATION:
