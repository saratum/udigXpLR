 ...
 * <ul>
 *   <li>{@link it.unibz.udig.omtg.td.model.impl.OMTGeoFieldClassImpl#getRepresentation <em>Representation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OMTGeoFieldClassImpl extends OMTClassImpl implements OMTGeoFieldClass
{
	...
	{
		return TDPackage.Literals.OMT_GEO_FIELD_CLASS;
	}
	...
	public void setRepresentation( OMTGeoFieldClassKind newRepresentation )
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TDPackage.OMT_GEO_FIELD_CLASS__REPRESENTATION, oldRepresentation, representation));
	}
	...
	public Object eGet( int featureID, boolean resolve, boolean coreType )
	{
		switch (featureID)
		{
			case TDPackage.OMT_GEO_FIELD_CLASS__REPRESENTATION:
