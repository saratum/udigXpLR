 ...
 * <ul>
 *   <li>{@link it.unibz.udig.omtg.td.model.impl.OMTGeoObjectGeometryClassImpl#getRepresentation <em>Representation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OMTGeoObjectGeometryClassImpl extends OMTClassImpl implements OMTGeoObjectGeometryClass
{
	...
	{
		return TDPackage.Literals.OMT_GEO_OBJECT_GEOMETRY_CLASS;
	}
	...
	public void setRepresentation( OMTGeoObjectGeometryClassKind newRepresentation )
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TDPackage.OMT_GEO_OBJECT_GEOMETRY_CLASS__REPRESENTATION, oldRepresentation, representation));
	}
	...
	public Object eGet( int featureID, boolean resolve, boolean coreType )
	{
		switch (featureID)
		{
			case TDPackage.OMT_GEO_OBJECT_GEOMETRY_CLASS__REPRESENTATION:
