...
deltarule: DR (LOWER|UPPER|UNDERSCORE|DIGITS|APICE)* EQUALS (LOWER|UPPER|UNDERSCORE|DIGITS|APICE)* 
         | DR (LOWER|UPPER|UNDERSCORE|DIGITS|APICE)* EQUALS (LOWER|UPPER|UNDERSCORE|DIGITS|APICE)* PLUS (LOWER|UPPER|UNDERSCORE|DIGITS|APICE)* 
           | DR (LOWER|UPPER|UNDERSCORE|DIGITS|APICE)* EQUALS (LOWER|UPPER|UNDERSCORE|DIGITS|APICE)* MINUS (LOWER|UPPER|UNDERSCORE|DIGITS|APICE)*
         | DR (LOWER|UPPER|UNDERSCORE|DIGITS|APICE)* EQUALS (LOWER|UPPER|UNDERSCORE|DIGITS|APICE)* relation (LOWER|UPPER|UNDERSCORE|DIGITS|APICE)*? ;
idrel: STRING;
semanticrule: STRING;
